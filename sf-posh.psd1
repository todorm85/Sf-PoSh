@{
    ...
    CLRVersion        = '4.0'
    FunctionsToExport = 'sf-macros-resetProject', 'sf-macros-applyLatestChanges', 'sf-macros-getAllUnused', 'sf-macros-setMasterOrPatchesBranchAndResetForAllUnused', 'sf-macros-runForUnusedProjects', 'sf-module-openConfig', 'sf-module-reload', 'sf-PSmodule-openDatabaseFile', 'Run-InProjectScope', 'Run-InFunctionAcceptingProjectFromPipeline', 'sf-project-setDescription', 'sf-project-getDescription', 'sf-project-new', 'sf-project-clone', 'sf-project-removeBulk', 'sf-project-remove', 'sf-project-rename', 'sf-project-get', 'sf-project-setCurrent', 'sf-project-save', 'sf-project-tags-setDefaultFilter', 'sf-project-tags-getDefaultFilter', 'sf-project-tags-addToDefaultFilter', 'sf-project-tags-removeFromDefaultFilter', 'sf-project-tags-filter', 'sf-project-tags-add', 'sf-project-tags-remove', 'sf-project-tags-get', 'sf-project-select', 'sf-app-ensureRunning', 'sf-app-initialize', 'sf-app-uninitialize', 'sf-app-reinitialize', 'sf-precompiledTemplates-add', 'sf-precompiledTemplates-remove', 'sf-app-isInitialized', 'sf-db-getNameFromDataConfig', 'sf-db-setNameInDataConfig', 'sf-iris-configureStandalone', 'sf-iris-install', 'sf-license-set', 'sf-siteSync-install', 'sf-siteSync-uninstall', 'sf-upgradeFrom', 'sf-wcf-invoke', 'sf-date-convertToJSFormat', 'sf-auth-ldap', 'sf-auth-azureB2C', 'sf-auth-facebook', 'sf-auth-aspsql', 'sf-auth-google', 'sf-auth-basic', 'sf-auth-basic-getHeaderValue', 'sf-auth-protocol', 'sf-localization-addCultures', 'sf-localization-removeCultures', 'sf-localization-setDefaultCulture', 'sf-localization-setSiteCultures', 'sf-localization-removeSiteCultures', 'sf-localization-setSiteDefaultCulture', 'sf-nginx-reset', 'sf-nlb-getNodes', 'sf-nlb-forAllNodes', 'sf-nlb-setSslOffloadForAll', 'sf-nlb-overrideOtherNodeConfigs', 'sf-nlb-resetAllNodes', 'sf-nlb-getUrl', 'sf-nlb-changeUrl', 'sf-nlb-openNlbSite', 'sf-nlb-getNlbId', 'sf-nlb-newCluster', 'sf-nlb-removeCluster', 'sf-nlb-getStatus', 'sf-seed-DynamicTypes', 'sf-seed-Sites-create', 'sf-seed-Users', 'sf-serverCode-run', 'sf-serverCode-deployDirectory', 'sf-states-save', 'sf-states-restore', 'sf-states-remove', 'sf-states-get', 'sf-paths-goto', 'RunInRootLocation', 'RunInLocation', 'sf-sol-build', 'sf-sol-rebuild', 'sf-sol-clean', 'sf-sol-packagesClear', 'sf-sol-open', 'sf-sol-buildWebAppProj', 'sf-sol-buildIntegrationTestsProject', 'sf-sol-unlockAllFiles', 'sf-sol-resetSitefinityFolder', 'sf-sol-executeIrisInstall', 'sf-sol-packagesRestore', 'sf-git-removeBranches', 'sf-git-isClean', 'sf-git-isBehind', 'sf-git-cleanDevArtefacts', 'sf-git-status', 'sf-git-getCurrentBranch', 'sf-git-isEnabled', 'sf-git-resetAllChanges', 'sf-git-checkout', 'sf-git-getCommitsBehind', 'sf-tests-startWebTestRunner', 'sf-tests-runIntTests', 'sf-tests-extractFailedResults', 'sf-tests-prepareIntTests', 'sf-uitests-openSolution', 'sf-uitests-setup', 'sf-config-open', 'sf-config-save', 'sf-config-update', 'xml-getOrCreateElementPath', 'xml-removeElementIfExists', 'sf-config-getFromDb', 'sf-config-clearInDb', 'sf-config-setInDb', 'sf-config-exportAllFromDb', 'sf-config-Startup-remove', 'sf-config-Startup-create', 'sf-config-System-setSslOffload', 'sf-config-System-setNlbUrls', 'sf-config-Web-setMachineKey', 'sf-config-Web-removeMachineKey', 'sf-config-Web-setStorageMode', 'sf-config-Web-getStorageMode', 'sf-bindings-add', 'sf-bindings-get', 'sf-bindings-remove', 'sf-bindings-getOrCreateLocalhostBinding', 'sf-bindings-getLocalhostBinding', 'sf-bindings-getLocalhostUrl', 'sf-iis-appPool-ResetThread', 'sf-iis-appPool-Reset', 'sf-iis-appPool-Stop', 'sf-iis-site-browse', 'sf-iis-site-new', 'sf-iis-site-delete', 'sf-iis-site-getSubAppName', 'sf-iis-subApp-set', 'sf-iis-subApp-remove', 'sf-iis-site-getBinding', 'sf-iis-site-setBinding', 'sf-iis-site-getUrl', 'sf-iis-site-changeDomain', 'asp-cleanTemp', 'git-clone', 'git-getAllBranches', 'git-completeBranchName', 'git-getAllLocalBranches', 'git-getCurrentBranch', 'git-resetAllChanges', 'iis-website-create', 'iis-isPortFree', 'iis-new-subApp', 'iis-remove-subApp', 'iis-set-sitePath', 'iis-bindings-getAll', 'iis-find-site', 'iis-getFreePort', 'iis-site-isStarted', 'os-nuget-clearCache', 'sf-module-updateNugetExe', 'os-popup-notification', 'os-test-isPortFree', 'execute-native', 'unlock-allFiles', 'os-hosts-add', 'os-hosts-get', 'os-hosts-remove', 'os-browseUrl', 'ui-promptItemSelect', 'sql-delete-database', 'sql-rename-database', 'sql-get-dbs', 'sql-get-items', 'sql-update-items', 'sql-insert-items', 'sql-delete-items', 'sql-test-isDbNameDuplicate', 'sql-copy-db', 'sql-createDb', 'sql-createTable'
    CmdletsToExport   = @()
    VariablesToExport = @()
    ...
    RequiredModules   = @(
        @{ModuleName = 'SqlServer'; ModuleVersion = '21.1.18179'; },
        'WebAdministration'
    )
    PrivateData       = @{
        PSData = @{
