@{
    ...
    CLRVersion        = '4.0'
    FunctionsToExport = 'sf-config-open', 'sf-project-setDescription', 'sf-project-getDescription', 'sf-project-new', 'sf-project-clone', 'sf-project-removeBulk', 'sf-project-remove', 'sf-project-rename', 'sf-project-getCurrent', 'sf-project-setCurrent', 'sf-project-getAll', 'sf-project-save', 'sf-projectTags-setDefaultFilter', 'sf-projectTags-getDefaultFilter', 'sf-projectTags-addToDefaultFilter', 'sf-projectTags-removeFromDefaultFilter', 'sf-projectTags-getAll', 'sf-projectTags-addToCurrent', 'sf-projectTags-removeFromCurrent', 'sf-projectTags-removeAllFromCurrent', 'sf-projectTags-getAllFromCurrent', 'sf-project-select', 'sf-project-show', 'sf-project-showAll', 'sf-db-getNameFromDataConfig', 'sf-db-setNameInDataConfig', 'sf', 'sf-app-sendRequestAndEnsureInitialized', 'sf-app-initialize', 'sf-app-uninitialize', 'sf-app-reinitialize', 'sf-appPrecompiledTemplates-add', 'sf-appPrecompiledTemplates-remove', 'sf-app-isInitialized', 'sf-appStates-save', 'sf-appStates-restore', 'sf-appStates-remove', 'sf-appStates-removeAll', 'sf-appStates-get', 'sf-bindings-add', 'sf-bindings-get', 'sf-bindings-remove', 'sf-bindings-getOrCreateLocalhostBinding', 'sf-bindings-getLocalhostBinding', 'sf-bindings-getLocalhostUrl', 'sf-iisAppPool-ResetThread', 'sf-iisAppPool-Reset', 'sf-iisAppPool-Stop', 'sf-iisSite-browse', 'sf-iisSite-new', 'sf-iisSite-delete', 'sf-iisSite-getSubAppName', 'sf-iisSubApp-set', 'sf-iisSubApp-remove', 'sf-iisSite-getBinding', 'sf-iisSite-setBinding', 'sf-iisSite-getUrl', 'sf-iisSite-changeDomain', 'sf-nginx-reset', 'sf-nlb-setup', 'sf-nlb-restoreToInitialNlbState', 'sf-nlb-restoreAllToState', 'sf-nlb-uninstall', 'sf-nlb-getOtherNodes', 'sf-nlb-forAllNodes', 'sf-nlb-setSslOffloadForAll', 'sf-nlb-overrideOtherNodeConfigs', 'sf-nlb-resetAllNodes', 'sf-nlb-getUrl', 'sf-nlb-getStatus', 'sf-nlb-openNlbSite', 'sf-configStartup-remove', 'sf-configStartup-create', 'sf-sol-build', 'sf-sol-rebuild', 'sf-sol-clean', 'sf-sol-clearPackages', 'sf-sol-open', 'sf-sol-buildWebAppProj', 'sf-sol-unlockAllFiles', 'sf-sol-resetSitefinityFolder', 'sf-sourceControl-undoPendingChanges', 'sf-sourceControl-showPendingChanges', 'sf-sourceControl-hasPendingChanges', 'sf-sourceControl-getLatestChanges', 'sf-serverCode-run', 'iis-website-create', 'iis-isPortFree', 'iis-new-subApp', 'iis-remove-subApp', 'iis-set-sitePath', 'iis-bindings-getAll', 'iis-find-site', 'iis-getFreePort', 'iis-site-isStarted', 'clear-nugetCache', 'os-popup-notification', 'os-test-isPortFree', 'execute-native', 'unlock-allFiles', 'os-hosts-add', 'os-hosts-get', 'os-hosts-remove', 'os-browseUrl', 'sql-delete-database', 'sql-rename-database', 'sql-get-dbs', 'sql-get-items', 'sql-update-items', 'sql-insert-items', 'sql-delete-items', 'sql-test-isDbNameDuplicate', 'sql-copy-db', 'sql-createDb', 'sql-createTable', 'tfs-get-workspaces', 'tf-query-workspaces', 'tfs-delete-workspace', 'tfs-create-workspace', 'tfs-create-mappings', 'tfs-checkout-file', 'tfs-get-latestChanges', 'tfs-undo-pendingChanges', 'tfs-show-pendingChanges', 'tfs-get-workspaceName', 'tfs-get-branchPath', 'tfs-get-lastWorkspaceChangeset'
    CmdletsToExport   = @()
    VariablesToExport = @()
