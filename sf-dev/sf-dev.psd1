@{
    ...
    CLRVersion        = '4.0'
    FunctionsToExport = 'sf-start-allProjectsBatch', 'sf-set-description', 'sf-new-project', 'sf-clone-project', 'sf-import-project', 'sf-delete-manyProjects', 'sf-delete-project', 'sf-rename-project', 'sf-update-allProjectsTfsInfo', 'sf-clean-allProjectsLeftovers', 'sf-reset-project', 'sf-select-project', 'sf-show-currentProject', 'sf-show-projects', 'sf-build-solution', 'sf-rebuild-solution', 'sf-clean-solution', 'sf-open-solution', 'sf-build-webAppProj', 'sf-unlock-allFiles', 'sf-switch-styleCop', 'sf-undo-pendingChanges', 'sf-show-pendingChanges', 'sf-get-hasPendingChanges', 'sf-get-latestChanges', 'sf-reset-thread', 'sf-reset-pool', 'sf-stop-pool', 'sf-change-pool', 'sf-get-poolId', 'sf-setup-asSubApp', 'sf-remove-subApp', 'sf-rename-website', 'sf-browse-webSite', 'sf-create-website', 'sf-goto', 'sf-set-storageMode', 'sf-get-storageMode', 'sf-get-configContentFromDb', 'sf-clear-configContentInDb', 'sf-insert-configContentInDb', 'sf-get-appDbName', 'sf-set-appDbName', 'sf-reset-app', 'sf-add-precompiledTemplates', 'sf-save-appState', 'sf-restore-appState', 'sf-delete-appState', 'sf-delete-allAppStates', 'sf-get-fluent', 'sf-clean-packages', 'sf-get-currentProject', 'sf-get-allProjects', 'sf-open-description'
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = '*'
    ModuleVersion     = '1.4.0'
