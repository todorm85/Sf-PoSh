@{
    ...
    CLRVersion        = '4.0'
    FunctionsToExport = 'iis-get-websitePort', 'iis-get-usedPorts', 'iis-create-website', 'iis-get-siteAppPool', 'iis-test-isPortFree', 'iis-test-isSiteNameDuplicate', 'iis-get-subAppName', 'iis-new-subApp', 'iis-remove-subApp', 'iis-set-sitePath', 'iis-set-binding', 'iis-get-binding', 'iis-find-site', 'clear-nugetCache', 'os-popup-notification', 'os-test-isPortFree', 'execute-native', 'unlock-allFiles', 'os-hosts-add', 'os-hosts-get', 'os-hosts-remove', 'sql-delete-database', 'sql-rename-database', 'sql-get-dbs', 'sql-get-items', 'sql-update-items', 'sql-insert-items', 'sql-delete-items', 'sql-test-isDbNameDuplicate', 'sql-copy-db', 'tfs-get-workspaces', 'tf-query-workspaces', 'tfs-delete-workspace', 'tfs-create-workspace', 'tfs-create-mappings', 'tfs-checkout-file', 'tfs-get-latestChanges', 'tfs-undo-pendingChanges', 'tfs-show-pendingChanges', 'tfs-get-workspaceName', 'tfs-get-branchPath', 'tfs-get-lastWorkspaceChangeset', 'sf-project-setDescription', 'sf-project-getDescription', 'sf-project-new', 'sf-project-clone', 'sf-project-removeBulk', 'sf-project-remove', 'sf-project-rename', 'sf-project-getCurrent', 'sf-project-use', 'sf-project-getAll', 'sf-project-tags-setDefaultFilter', 'sf-project-tags-getDefaultFilter', 'sf-project-tags-addToDefaultFilter', 'sf-project-tags-removeFromDefaultFilter', 'sf-project-tags-getAll', 'sf-project-tags-addToCurrent', 'sf-project-tags-removeFromCurrent', 'sf-project-tags-removeAllFromCurrent', 'sf-project-tags-getAllFromCurrent', 'sf-project-select', 'sf-project-show', 'sf-project-showAll', 'sf-app-waitForSitefinityToStart', 'sf-app-reinitializeAndStart', 'sf-app-addPrecompiledTemplates', 'sf-sol-removeStartupConfig', 'sf-sol-createStartupConfig', 'sf-db-getNameFromDataConfig', 'sf-db-setNameInDataConfig', 'sf-sol-build', 'sf-sol-rebuild', 'sf-sol-clean', 'sf-sol-clearPackages', 'sf-sol-open', 'sf-sol-buildWebAppProj', 'sf-sol-unlockAllFiles', 'sf-sol-resetSitefinityFolder', 'sf-sol-source-undoPendingChanges', 'sf-sol-source-showPendingChanges', 'sf-sol-source-hasPendingChanges', 'sf-sol-source-getLatestChanges', 'sf-app-states-save', 'sf-app-states-restore', 'sf-app-states-remove', 'sf-app-states-removeAll', 'sf-iis-poolresetThread', 'sf-iis-poolreset', 'sf-iis-poolstop', 'sf-iis-site-browse', 'sf-iis-site-new', 'sf-iis-site-delete', 'sf-iis-site-changeDomain', 'sf-iis-site-getUrl', 'sf-iis-subApp-set', 'sf-iis-subApp-remove'
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = '*'
