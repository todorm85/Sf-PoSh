@{
    ...
    CLRVersion        = '4.0'
    FunctionsToExport = 'sf-get-allProjects', 'sf-start-allProjectsBatch', 'sf-set-description', 'sf-new-project', 'sf-clone-project', 'sf-import-project', 'sf-delete-manyProjects', 'sf-delete-project', 'sf-rename-project', 'sf-reset-project', 'sf-get-currentProject', 'sf-open-description', 'sf-add-tagToProject', 'sf-remove-tagFromProject', 'sf-remove-allTagsFromProject', 'sf-get-allTagsForProject', 'sf-set-defaultTagFilter', 'sf-get-defaultTagFilter', 'sf-update-allProjectsTfsInfo', 'sf-clean-allProjectsLeftovers', 'sf-goto', 'sf-select-project', 'sf-show-currentProject', 'sf-show-projects', 'sf-build-solution', 'sf-rebuild-solution', 'sf-clean-solution', 'sf-clean-packages', 'sf-open-solution', 'sf-build-webAppProj', 'sf-unlock-allFiles', 'sf-switch-styleCop', 'sf-undo-pendingChanges', 'sf-show-pendingChanges', 'sf-get-hasPendingChanges', 'sf-get-latestChanges', 'sf-reset-thread', 'sf-reset-pool', 'sf-stop-pool', 'sf-change-pool', 'sf-get-poolId', 'sf-setup-asSubApp', 'sf-remove-subApp', 'sf-rename-website', 'sf-browse-webSite', 'sf-create-website', 'sf-set-storageMode', 'sf-get-storageMode', 'sf-get-configContentFromDb', 'sf-clear-configContentInDb', 'sf-insert-configContentInDb', 'sf-get-appDbName', 'sf-set-appDbName', 'sf-reset-app', 'sf-add-precompiledTemplates', 'sf-save-appState', 'sf-restore-appState', 'sf-delete-appState', 'sf-delete-allAppStates'
    CmdletsToExport   = @()
    VariablesToExport = @()
    AliasesToExport   = '*'
    ModuleVersion     = '2.0.0'
