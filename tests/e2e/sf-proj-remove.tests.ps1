...
InModuleScope sf-dev {
    ...
    Describe "Remove should" -Tags ("delete") {
        It "remove all" {
            ...
            sf-proj-remove -noPrompt
            
            $sitefinities = @(sf-data-getAllProjects) | Where-Object { $_.id -eq $testId }
            ...
            $GLOBAL:Sf.sql.GetDbs() | Where-Object { $_.Name.Contains($testId) } | Should -HaveCount 0
